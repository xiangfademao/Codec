...
public class MainActivity extends Activity {
    ...
    private static final int AMR_ENCODER = AmrDecoder.AMR_NB;
    ...
    public void onDecode(View view) {
        ...
        if (mAmrFileDecoder == null) {
            mAmrFileDecoder = new AmrFileDecoder(AMR_ENCODER);
        }
        if (!isDecoding) {
            mAmrFileDecoder.start(getResources().openRawResource(AMR_ENCODER == AmrDecoder.AMR_NB ? R.raw.demo_nb : R.raw.demo_wb));
